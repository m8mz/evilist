...
> Plain dark graphite (#191919) background and nothing else. No text, no logos, no watermark, no frame. No
...
**Ladder** (the arc: stronger, better looking and more of a badass with every rank, from baggy
clothes and an innocent look to a tailored black suit with a long coat from S; the character stays
original, the arc is what the references lend. `src/data/deck.ts` is the source of truth; these rows
mirror it):

| Rank | Outfit                                                                                                                                                    | Eyes                                                    | Expression                                                                                | Posture                                                                        |
| ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| E    | An oversized grey hoodie hanging loose off narrow shoulders, the hood bunched at the neck, a headset around the neck, a company lanyard                   | Wide, warm brown `#6b4a2f`, no glow                     | Open, eager, a little anxious, the hair falling over his eyes                             | Slight frame, shoulders rounded and slightly forward, lost in the baggy hoodie |
| D    | A black company polo still a size too big, sleeves pushed up, no headset                                                                                  | Slightly narrower, a cold grey glint `#7a8088`          | Focused, the start of a smile, the hair pushed off his brow                               | Upright, the shoulders starting to square                                      |
| C    | A fitted black shirt, a laptop-bag strap across a broader chest                                                                                           | Steel grey `#96a0aa`, alert                             | Determined, the jaw sharper                                                               | Head a touch down, eyes up, the frame filling out                              |
| B    | A fitted black shirt with the sleeves rolled over solid forearms, a coiled ethernet cable over one shoulder, its RJ45 plug hanging in view                | Steel grey with a faint violet rim on the iris          | Tired but sharp, a hard-won calm                                                          | Jaw set, shoulders squared                                                     |
| A    | A fitted black technical shirt over a broad frame, an open laptop held up in both hands with its lid toward the viewer                                    | Violet iris `#7040d2`, no glow                          | Quiet confidence, a knowing half-smile, the hair swept back with one strand over the brow | Standing tall, squared shoulders, chin level                                   |
| S    | A tailored black suit cut close to his figure: a long black coat with sharp lapels over a white shirt buttoned to the collar, no tie                      | Violet iris, glowing `#9d7cf0`                          | Calm authority, the hint of a smirk, the hair swept back and sharp                        | Chin level, slight three-quarter turn, broad shoulders filling the coat        |
| S+   | The long black coat open over a black shirt that matches it, violet energy visible inside it and at the shoulders, violet light catching the coat's edges | White-violet `#e6ddff`, the glow breaking past the lids | Serene, unbothered, every line of the face sharp                                          | Chin slightly up, energy rising, the frame at its strongest                    |
