...
| Stage id                | Row                                                                                                                                                                                                |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `t1-support`            | Wearing a grey hoodie, a headset around the neck, a company lanyard. Eyes wide and warm brown (#6b4a2f), no glow. Expression open, eager, a little anxious. Shoulders slightly forward.            |
| `web-concierge`         | Wearing a dark company polo, no headset, sleeves pushed up. Eyes slightly narrower with a cold grey glint (#7a8088). Expression focused, the start of a smile. Posture upright.                    |
| `professional-services` | Wearing a black shirt with a laptop-bag strap across the chest. Eyes steel grey (#96a0aa), alert. Expression determined. Head a touch down, eyes up.                                               |
| `t3-support`            | Sleeves rolled, a coiled patch cable over one shoulder. Eyes steel grey with a faint violet rim on the iris. Expression tired but sharp. Jaw set.                                                  |
| `sysadmin`              | Wearing a fitted black technical shirt, rack keys on a carabiner. Eyes a violet iris (#7040d2), no glow. Expression quiet confidence. Squared shoulders.                                           |
| `linux-engineer`        | Wearing a dark technical coat closed to the collar. Eyes a violet iris, glowing (#9d7cf0). Expression calm authority. Chin level, a slight three-quarter turn.                                     |
| `systems-architect`     | The coat open, violet energy visible inside it and at the shoulders. Eyes white-violet (#e6ddff), the glow breaking past the lids. Expression serene, unbothered. Chin slightly up, energy rising. |
